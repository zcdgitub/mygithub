				...
				<div class="widget-content nopadding">
					<form  class="form-horizontal" action="" method="post">							
						<div class="form-group">
                            ...
                            <div class=" col-sm-9 col-md-9 col-lg-10">
                            	<div class="input-group input-group-sm">
                                	...
                                	<input type="text" value="<?php echo ($data["g_id"]); ?>" class="form-control input-sm" id="g_id" readonly/>
                                </div>
                            </div>
                        </div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9 col-md-9 col-lg-10">
								<textarea rows="5" class="form-control" id="g_content"><?php echo ($data["g_content"]); ?></textarea>
							</div>
						</div>
                        ...
                        <div class="form-group">
                            ...
                            <div class=" col-sm-9 col-md-9 col-lg-10">
                            	<div class="input-group input-group-sm">
									<span class="input-group-addon"><i class="fa fa-user"></i></span>
                                	<input type="text" value="<?php echo (session('uname')); ?>" class="form-control input-sm" id="g_rname" name="g_rname" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
							...
							<textarea rows="5" class="form-control" id="content-text" name="g_rcontent"><?php echo ($info["g_rcontent"]); ?></textarea>
							</div>
						</div>
						<!-- <div class="form-group">
