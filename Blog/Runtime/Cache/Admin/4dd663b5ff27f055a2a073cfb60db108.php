                        ...
                        <form action="" method="post" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-md-9 col-lg-10">
                                     ...
                                     <script id="ueditor" name="s_content" type="text/plain" style="width:800px;height:500px;"><?php echo (htmlspecialchars_decode($shuoshuo["s_content"])); ?></script>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class=" col-sm-9 col-md-9 col-lg-10">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="text" value="<?php echo (date('Y-m-d H:i:s',$shuoshuo["s_time"])); ?>" class="form-control input-sm" id="time" name="s_time" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-md-9 col-lg-10">
                                    <label><input type="radio" name="s_view" value="0" <?php if(($shuoshuo["s_view"]) == "0"): ?>checked="checked"<?php endif; ?> /> 不显示</label>
                                    <label><input type="radio" name="s_view" value="1" <?php if(($shuoshuo["s_view"]) == "1"): ?>checked="checked"<?php endif; ?> /> 显示</label>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class=" col-sm-9 col-md-9 col-lg-10">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="text" value="<?php echo getOs();?>" class="form-control input-sm" id="from"  name="s_from" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class=" col-sm-9 col-md-9 col-lg-10">
                                    <div class="input-group input-group-sm">
                                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                        <input type="text" value="<?php echo ($shuoshuo["s_author"]); ?>"  class="form-control input-sm" id="user" name="s_author" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class=" col-sm-9 col-md-9 col-lg-10">
                                    <div class="input-group input-group-sm">
                                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                        <input type="text" value="<?php echo get_client_ip();?>" class="form-control input-sm" id="ip" name="s_ip" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class=" col-sm-9 col-md-9 col-lg-10">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="text" value="<?php echo (C("HIT")); ?>" class="form-control input-sm" id="hit" name="s_hit" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-actions">                        
                              ...
                              <input type="hidden" name="s_id" value="<?php echo ($shuoshuo["s_id"]); ?>">
                        </form>
                    </div>
                </div>                        
            </div>
