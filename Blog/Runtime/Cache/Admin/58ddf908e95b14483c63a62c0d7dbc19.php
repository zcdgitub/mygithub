                        ...
                        <form action="" method="post" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-md-9 col-lg-10">
                                     ...
                                     <script id="ueditor" name="s_content" type="text/plain" style="width:800px;height:500px;"></script>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class=" col-sm-9 col-md-9 col-lg-10">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="text" value="" class="form-control input-sm" id="time" name="s_time" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-md-9 col-lg-10">
                                    <label><input type="radio" name="s_view" value="0"  /> 不显示</label>
                                    <label><input type="radio" name="s_view" value="1"  /> 显示</label>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class=" col-sm-9 col-md-9 col-lg-10">
                                    <div class="input-group input-group-sm">
                                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                        <input type="text" value=""  class="form-control input-sm" id="user" name="s_author" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
