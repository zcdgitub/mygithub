									...
									<div class="form-group">
                                        ...
                                        <div class=" col-sm-9 col-md-9 col-lg-10">
                                        	<div class="input-group input-group-sm">
                                            	...
                                            	<input type="text" value="<?php echo ($data["t_name"]); ?>" class="form-control input-sm" placeholder="栏目名" name="t_name" />
                                            </div>
                                        </div>
                                    </div>
                                   <div class="form-group">
                                        <label class="col-sm-3 col-md-3 col-lg-1 control-label">上级分类</label>
                                        <div class=" col-sm-9 col-md-9 col-lg-10">
                                            <div class="input-group input-group-sm">
                                                <select name="t_parent_id">
                                                    <option value="0">顶级分类</option>
                                                    <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["t_id"]); ?>" <?php if(($data["t_parent_id"]) == $vo["t_id"]): ?>selected="selected"<?php endif; ?>><?php echo (str_repeat("--",$vo["lev"])); echo ($vo["t_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                </select>
									...
									<div class="form-group">
										...
										<div class="col-sm-9 col-md-9 col-lg-10">
											<textarea rows="5" class="form-control" name="t_remark"><?php echo ($data["t_remark"]); ?></textarea>
										</div>
									</div>
									...
									<div class="form-group">
                                        ...
                                        <div class=" col-sm-9 col-md-9 col-lg-10">
                                        	<div class="row">
                                        		<div class="col-md-6">
                                            		<input type="datetime" value="<?php echo (date('Y-m-d H:i:s',$data["t_time"])); ?>" class="form-control input-sm"  id="time" name="t_time" />
                                            	</div>
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <div class=" col-sm-9 col-md-9 col-lg-10">
                                        	<div class="input-group input-group-sm">
                                            	...
                                            	<input type="text" value="<?php echo ($data["t_root"]); ?>" class="form-control input-sm" id="root" name="t_root" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9 col-md-9 col-lg-10">
											<label><input type="radio" name="t_view" value="0" <?php if(($data["t_view"]) == "0"): ?>checked="checked"<?php endif; ?> /> Not show</label>
											<label><input type="radio" name="t_view" value="1" <?php if(($data["t_view"]) == "1"): ?>checked="checked"<?php endif; ?>/> Show</label>
										</div>
									</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class=" col-sm-9 col-md-9 col-lg-10">
                                        	<div class="input-group input-group-sm">
                                            	...
                                            	<input type="text" value="<?php echo ($data["t_sort"]); ?>" class="form-control input-sm" id="sort" name="t_sort" />
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <div class=" col-sm-9 col-md-9 col-lg-10">
                                        	<div class="input-group input-group-sm">
												<span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            	<input type="text" value="<?php echo getOs();?>" class="form-control input-sm" id="from" name="t_from" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class=" col-sm-9 col-md-9 col-lg-10">
                                        	<div class="input-group input-group-sm">
												<span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            	<input type="text" value="<?php echo get_client_ip();?>" class="form-control input-sm" id="ip" name="t_ip" />
                                            </div>
                                        </div>
                                    </div>
