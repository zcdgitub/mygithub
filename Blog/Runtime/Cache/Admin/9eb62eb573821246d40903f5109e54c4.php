							...
							<div class="form-group">
								...
								<div class="col-sm-9 col-md-9 col-lg-10">
									<select name="p_pid">
										...
										<?php if(is_array($album)): $i = 0; $__LIST__ = $album;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["al_id"]); ?>" <?php if(($data["p_pid"]) == $vo["al_id"]): ?>selected="selected"<?php endif; ?> ><?php echo ($vo["al_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
								</div>
							</div>
					<div class="form-group">
					...
					<div class="spinner" style="display: none">Loading...</div>
						...
						<input type="file" name="p_img" />
							...
							<div class="form-group">
                                ...
                                <div class=" col-sm-9 col-md-9 col-lg-10">
                                	<div class="input-group input-group-sm">
                                    	...
                                    	<input type="text" value="<?php echo (date('Y-m-d H:i:s',$data["p_time"])); ?>" class="form-control input-sm" id="time" name="p_time" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-9 col-md-9 col-lg-10">
									<label><input type="radio" name="p_view" value="0" <?php if(($data["p_view"]) == "0"): ?>checked="checked"<?php endif; ?> /> Not show</label>
									<label><input type="radio" name="p_view" value="1" <?php if(($data["p_view"]) == "1"): ?>checked="checked"<?php endif; ?> /> Show</label>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9 col-md-9 col-lg-10">
									<textarea rows="3" class="form-control" name="p_remark"><?php echo ($data["p_remark"]); ?></textarea>
								</div>
							</div>
                            ...
                            <label class="col-sm-3 col-md-3 col-lg-1 control-label">添加人</label>
                                <div class=" col-sm-9 col-md-9 col-lg-10">
                                	<div class="input-group input-group-sm">
                                    	...
                                    	<input type="text" value="<?php echo ($data["p_root"]); ?>" class="form-control input-sm" name="p_root" />
                                    </div>
                                </div>
                            </div>
