									...
									<div class="form-group">
                                        ...
                                        <div class=" col-sm-9 col-md-9 col-lg-10">
                                        	<div class="input-group input-group-sm">
                                            	...
                                            	<input type="text" value="" class="form-control input-sm" placeholder="栏目名" name="t_name" />
                                            </div>
                                        </div>
                                    </div>
                                   <div class="form-group">
                                        ...
                                        <div class=" col-sm-9 col-md-9 col-lg-10">
                                            <div class="input-group input-group-sm">
                                                <select name="t_parent_id">
                                                    ...
                                                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["t_id"]); ?>" ><?php echo (str_repeat("--",$vo["lev"])); echo ($vo["t_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                </select>
									...
									<div class="form-group">
                                        ...
                                        <div class=" col-sm-9 col-md-9 col-lg-10">
                                        	<div class="row">
                                        		<div class="col-md-6">
                                            		<input type="datetime" value="" class="form-control input-sm"  id="time" name="t_time" />
                                            	</div>
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <div class=" col-sm-9 col-md-9 col-lg-10">
                                        	<div class="input-group input-group-sm">
                                            	...
                                            	<input type="text" value="" class="form-control input-sm" id="root" name="t_root" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9 col-md-9 col-lg-10">
											<label><input type="radio" name="t_view" value="0"  /> Not show</label>
											<label><input type="radio" name="t_view" value="1" /> Show</label>
										</div>
									</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class=" col-sm-9 col-md-9 col-lg-10">
                                        	<div class="input-group input-group-sm">
                                            	...
                                            	<input type="text" value="" class="form-control input-sm" id="sort" name="t_sort" />
                                            </div>
                                        </div>
                                    </div>
