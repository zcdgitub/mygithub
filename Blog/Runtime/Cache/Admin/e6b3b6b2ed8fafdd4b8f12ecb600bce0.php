					...
					<div class="widget-content nopadding">
						<form method="post" class="form-horizontal" action="" enctype="multipart/form-data">
							...
							<div class="form-group">
                                ...
                                <div class=" col-sm-9 col-md-9 col-lg-10">
                                	<div class="input-group input-group-sm">
                                    	...
                                    	<input type="text" class="form-control input-sm" placeholder="相册名字" name="al_name" value=""/>
                                    </div>
                                </div>
                            </div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9 col-md-9 col-lg-10">
									<textarea rows="5" class="form-control" name="al_remark"></textarea>
								</div>
							</div>
                                ...
                                <div class=" col-sm-9 col-md-9 col-lg-10">
                                	<div class="row">
                                		<div class="col-md-6">
                                    		...
                                    		<input type="text" value="" class="form-control input-sm" name="al_time"  id="time" />
                                    	</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class=" col-sm-9 col-md-9 col-lg-10">
                                	<div class="input-group input-group-sm">
										<span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    	<input type="text" value="" class="form-control input-sm" name="al_root"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-9 col-md-9 col-lg-10">
									<label><input type="radio" name="al_view" value="1"/> Yes</label>
									<label><input type="radio" name="al_view" value="0" /> No</label>
								</div>
							</div>
