						...
						<form enctype="multipart/form-data"  action=""   method="post" class="form-horizontal" >
							<div class="form-group">
								...
								<div class="col-sm-9 col-md-9 col-lg-10">
									<input type="text" class="form-control input-sm" name="a_title" value=""/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9 col-md-9 col-lg-10">
									<div class="input-group input-group-sm">
										...
										<input type='text' class="form-control input-sm" placeholder="一个关键词" name="a_keyword" value=""/>
				...
				<div class="col-sm-9 col-md-9 col-lg-10">
						...
						<br/>
							...
							<div class="form-group">
								...
								<div class="col-sm-9 col-md-9 col-lg-10">
									<textarea rows="3" class="form-control" name="a_remark"></textarea>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9 col-md-9 col-lg-10">
									 <script id="ueditor" name="a_content" type="text/plain" style="width: 800px;height: 500px;"></script> 
							...
							<div class="form-group">
                                ...
                                <div class=" col-sm-9 col-md-9 col-lg-10">
                                	<div class="input-group input-group-sm">
                                    	...
                                    	<input type="text" value="" class="form-control input-sm" name="a_time" id="time" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-9 col-md-9 col-lg-10">
									<label><input type="radio" name="a_view" value="0" > Not show</label>
									<label><input type="radio" name="a_view" value="1"  /> Show</label>
									<label><input type="radio" name="a_view" value="2"  /> Hot</label>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9 col-md-9 col-lg-10">
									<label><input type="radio" name="a_original" value="1" /> Yes</label>
									<label><input type="radio" name="a_original" value="0"  /> No</label>
								</div>
							</div>
							<div class="form-group">
                                ...
                                <div class=" col-sm-9 col-md-9 col-lg-10">
                                	<div class="input-group input-group-sm">
                                    	...
                                    	<input type="text" value=""  class="form-control input-sm" name="a_author" />
                                    </div>
                                </div>
                            </div>
