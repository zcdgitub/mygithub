        ...
        <div class="col-md-8 row-l articles">
        	<div class="media feel-info">
				...
				<div class="media-body feel-info-content">				    
				    <?php echo (htmlspecialchars_decode($info["s_content"])); ?>				    
				</div>
          ...
          <div class="a-up"><p>上一篇：<?php if(empty($prev["s_id"])): ?>&nbsp;没有了<?php else: ?><a title='' href="<?php echo U('info','id='.$prev['s_id']);?>">&nbsp;<?php echo (msubstr(htmlspecialchars_decode($prev["s_content"]),0,40,'utf-8',ture)); ?></a><?php endif; ?></p></div>
           <div class="a-down"><p>下一篇：<?php if(empty($next["s_id"])): ?>&nbsp;没有了<?php else: ?><a title='' href="<?php echo U('info','id='.$next['s_id']);?>">&nbsp;<?php echo (msubstr(htmlspecialchars_decode($next["s_content"]),0,10,'utf-8',ture)); ?></a><?php endif; ?></p></div> 
            ...
            <div class="home-from">
                ...
                <div class="collapse" id="collapseExample">
					...
					<input id="jump" type="hidden"  value="/Say/info/id/2.html" />
