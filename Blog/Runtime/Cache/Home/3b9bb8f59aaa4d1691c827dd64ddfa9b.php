...
<!-- http://www.jq22.com/jquery -->
		<div class="row aerousel">
			...
			<div class="col-md-8 row-l about-all">
				<h4>关于我</h4><hr />
				<div class="about">
					<p><img class="image-light about-img thumbnail" src="/Public/Img/my.jpg" style="width:450px;height:300px;display: block;"/></p>
					<p><strong>姓名</strong>：张冲</p>
					<p><strong>网名</strong>：叶落边城</p>
					<p class="hidden-xs"><img src="https://r.qzone.qq.com/cgi-bin/cgi_get_user_pic?openid=00000000000000000000000003082943&pic=8.jpg&key=132b834535b821f1ea4617c3545247af" ></p>
					<p><strong>我的二八年华</strong><br/>
					自己仍然是一个不折不扣菜鸟,喜欢在网络上寻找存在和分享自己的学习和经验.</p>
					<p><strong>喜欢的话</strong><br/>人活着就是为了生存，而生存易生活难，每每很多问题困扰我的时候，我总是想着自己的网名：<a>叶落边城</a>，然后让自己开开心心的过每一天，把不开心的事都一一过滤。每一天都有计划和学习，那样的日子才是最好的，不是么？</p>					
				</div>
