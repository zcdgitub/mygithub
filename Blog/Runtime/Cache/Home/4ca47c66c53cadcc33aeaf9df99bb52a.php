...
<!-- http://www.jq22.com/jquery -->
	<div class="row aerousel">
		...
		<div class="col-md-8 row-l">
			<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="media feel">
					<div class="f-time"><a><span class="glyphicon glyphicon-dashboard"></span></a>&nbsp;&nbsp;<?php echo (date("Y-m-d H:i:s",$v["s_time"])); ?> 在 <a class="from"><?php echo ($v["s_from"]); ?></a> 说到：</div>
					<div class="media-left media-middle">
					    <img class="media-object img-50" src="<?php echo ($system["admin_img"]); ?>" alt="...">
					</div>
					<div class="media-body feel-body"><a href="<?php echo U('info','id='.$v['s_id']);?>"><?php echo (htmlspecialchars_decode($v["s_content"])); ?></a></div>
