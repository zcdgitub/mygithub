                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                           	<ul class="nav navbar-nav">
	                            ...
	                            <li class="dropdown dh <?php echo ($class); ?>">
	                                ...
	                                <?php if(is_array($tag)): $i = 0; $__LIST__ = $tag;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('article/lists','id='.$vo['t_id']);?>" ><i class="icon-ok-sign"></i> <?php echo ($vo["t_name"]); ?></a></li>
...
<!-- http://www.jq22.com/jquery -->
	 <div class="container hidden-xs ppt">
		            <div id="ppt-main" class="nivoSlider">
		                <a href="<?php echo ($ppt["0"]["pp_url"]); ?>" target="_blank"><img src="<?php echo ($ppt["0"]["pp_img"]); ?>" alt=""  title="<?php echo ($ppt["0"]["pp_note"]); ?> " /></a>   
		               <a href="<?php echo ($ppt["1"]["pp_url"]); ?>" target="_blank"><img src="<?php echo ($ppt["1"]["pp_img"]); ?>" alt=""  title="<?php echo ($ppt["1"]["pp_note"]); ?> " /></a>
    					<a href="<?php echo ($ppt["2"]["pp_url"]); ?>" target="_blank"><img src="<?php echo ($ppt["2"]["pp_img"]); ?>" alt=""  title="<?php echo ($ppt["2"]["pp_note"]); ?> " /></a>
		            </div>
		</div> 
		<div class="row aerousel">
			...
			<?php if(is_array($articles)): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "暂时没有文章" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><article> 
				<h5>
					<?php if(($vo["a_original"]) == "1"): ?><span class="original">【原创】</span>
					<?php else: ?>
						<span class="reprint">【转载】</span><?php endif; ?>
					<a href="<?php echo U('/article/index','id='.$vo['a_id']);?>"><?php echo ($vo["a_title"]); ?></a>
				...
				<div class="clearfix" >           
						<ul>
							...
							<a class="article-img-a image-light" href="<?php echo U('/article-'.$v['a_id']);?>"><img src="/<?php echo ($vo["a_img"]); ?>" class="article-img" alt="<?php echo ($vo["a_title"]); ?>" title="<?php echo ($vo["a_title"]); ?>" /></a>
							<p>
