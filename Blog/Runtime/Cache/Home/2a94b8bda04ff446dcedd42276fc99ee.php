				...
				<div class="clearfix" >           
						<ul>
							...
							<span class="glyphicon glyphicon-time"></span></a>&nbsp;<?php echo (getTime($vo["a_time"])); ?>&nbsp;&nbsp;作者：<?php echo ($vo["a_author"]); ?>&nbsp;&nbsp;分类：[&nbsp;<?php echo ($vo["t_name"]); ?>&nbsp;]<span class="hidden-xs">&nbsp;&nbsp;浏览：&nbsp;&nbsp;</span>
								...
								<a class="article-img-a image-light" href="<?php echo U('article/index','id='.$vo['a_id']);?>" style=""><img src="/<?php echo ($vo["a_img"]); ?>" class="article-img" alt="<?php echo ($vo["a_title"]); ?>" title="<?php echo ($vo["a_title"]); ?>" style="width:170px;height:137px;display: block;"></a>
